...
export const edit_service = (description,fee,sanses,service_name,service_id,capacity,is_protected,old_password,new_password,cancellation_range,capacity_changed) => {
    ...
    return function(dispatch){
        return (edit_service_api.edit_service(description,fee,sanses,service_name,service_id,capacity,is_protected,old_password,new_password,cancellation_range,capacity_changed))
                                    .then((response) => {
                                        if(response){
